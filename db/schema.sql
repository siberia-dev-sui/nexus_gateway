...
-- ─────────────────────────────────────────
-- ASIGNACIÓN CLIENTE + EMPRESA → LISTA DE PRECIO
-- Fuente de verdad: res.partner.property_product_pricelist en contexto company
-- ─────────────────────────────────────────
...
-- ─────────────────────────────────────────
-- SNAPSHOT DE PRECIOS POR LISTA + EMPRESA
-- ─────────────────────────────────────────
...
-- ─────────────────────────────────────────
-- COLA DEDUPLICADA DE SINCRONIZACIÓN DE LISTAS
-- ─────────────────────────────────────────
...
-- ─────────────────────────────────────────
-- CACHE DE EMPRESAS POR VENDEDOR
-- ─────────────────────────────────────────
